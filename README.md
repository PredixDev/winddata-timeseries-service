...
```
predix.oauth.restHost=put.your.uaa.uri.here <For example: 5f37babc-08cd-4d3c-9f7f-0ffd3b474f0f.predix-uaa-sysint.grc-apps.svc.ice.ge.com>
...
predix.timeseries.zoneid=put.your.timeseries.zoneid.aka.instanceid.here  <For example: e1bbe838-f3ac-49c1-90fa-a0b3dc76c3e9>
```
